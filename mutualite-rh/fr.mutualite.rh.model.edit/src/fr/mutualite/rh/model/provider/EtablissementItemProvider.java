...
/**
 * This is the item provider adapter for a {@link fr.mutualite.rh.model.Etablissement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EtablissementItemProvider 
	 ...
	 * @generated
	 */
	public EtablissementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Etablissement_nom_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Etablissement_nom_feature", "_UI_Etablissement_type"),
				 MutPackage.Literals.ETABLISSEMENT__NOM,
				 true,
				 false,
				 false,
	...
	protected void addEmployesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Etablissement_employes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Etablissement_employes_feature", "_UI_Etablissement_type"),
				 MutPackage.Literals.ETABLISSEMENT__EMPLOYES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Etablissement_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Etablissement_id_feature", "_UI_Etablissement_type"),
				 MutPackage.Literals.ETABLISSEMENT__ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns Etablissement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Etablissement"));
	}
	...
	public String getText(Object object) {
		String label = ((Etablissement)object).getNom();
		return label == null || label.length() == 0 ?
			getString("_UI_Etablissement_type") :
			getString("_UI_Etablissement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Etablissement.class)) {
