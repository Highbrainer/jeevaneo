...
/**
 * This is the item provider adapter for a {@link fr.mutualite.rh.model.Formation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Formation_libelle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Formation_libelle_feature", "_UI_Formation_type"),
				 MutPackage.Literals.FORMATION__LIBELLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MutPackage.Literals.FORMATION__SESSIONFORMATION);
		}
	...
	public String getText(Object object) {
		String label = ((Formation)object).getLibelle();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MutPackage.Literals.FORMATION__SESSIONFORMATION,
				 MutFactory.eINSTANCE.createSessionFormation()));
	}
