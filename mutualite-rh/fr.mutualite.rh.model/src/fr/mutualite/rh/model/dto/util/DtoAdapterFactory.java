...
public class DtoAdapterFactory extends AdapterFactoryImpl {
	...
	protected DtoSwitch<Adapter> modelSwitch =
		new DtoSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUIEmploye(UIEmploye object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.mutualite.rh.model.dto.Formulaire <em>Formulaire</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.mutualite.rh.model.dto.UIEmploye <em>UI Employe</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
