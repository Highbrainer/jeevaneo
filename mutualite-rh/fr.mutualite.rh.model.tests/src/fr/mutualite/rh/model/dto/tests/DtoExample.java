...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>dto</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DtoExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dto"));
				Formulaire root = DtoFactory.eINSTANCE.createFormulaire();
