...
public class MutExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.mut"));
				Employe root = MutFactory.eINSTANCE.createEmploye();
