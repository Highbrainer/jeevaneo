/**
 */
package fr.mutualite.rh.model.config.tests;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>config</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.config"));
				Configuration root = ConfigFactory.eINSTANCE.createConfiguration();
