...
/**
 * This is the item provider adapter for a {@link mutualite.rh.chequedej.Cheque} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChequeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cheque_matricule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cheque_matricule_feature", "_UI_Cheque_type"),
				 ChequedejPackage.Literals.CHEQUE__MATRICULE,
				 true,
				 false,
				 false,
	...
	protected void addNbChequesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cheque_nbCheques_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cheque_nbCheques_feature", "_UI_Cheque_type"),
				 ChequedejPackage.Literals.CHEQUE__NB_CHEQUES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Cheque cheque = (Cheque)object;
		return getString("_UI_Cheque_type") + " " + cheque.getMatricule();
	}
