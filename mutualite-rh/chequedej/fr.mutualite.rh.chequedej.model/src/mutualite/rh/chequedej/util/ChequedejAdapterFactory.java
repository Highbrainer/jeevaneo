...
public class ChequedejAdapterFactory extends AdapterFactoryImpl {
	...
	protected ChequedejSwitch<Adapter> modelSwitch =
		new ChequedejSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAvance(Avance object) {
				return createAvanceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link mutualite.rh.chequedej.Avance <em>Avance</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
