...
public class ChequeDejImpl extends MinimalEObjectImpl.Container implements ChequeDej {
	...
	/**
	 * The cached value of the '{@link #getSolde() <em>Solde</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getSolde()
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getDejes() <em>Dejes</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getDejes()
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getCommandeMaxParDefaut() <em>Commande Max Par Defaut</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getCommandeMaxParDefaut() <em>Commande Max Par Defaut</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getCommandeMaxParDefaut()
	 * @generated
	 * @ordered
	...
	public void integrateDeje(String mois, int matricule, int nbEstimeJoursEntiersMoisSuivant, Integer nbReelJoursEntiersMoisPrecedent) {
		...
		Avance avance = diMoisPrecedent.getAvance();
		if(avance!=null) {
			// Une avance pour le mois précédent : on retire du solde!
			si.incremente(-avance.getNbCheques(), "Avance de " + avance.getNbCheques() + " cheque" + (avance.getNbCheques()>1?"s":"") + " faite le " + DateFormat.getDateInstance(DateFormat.MEDIUM).format(avance.getDate()) + " pour " + moisPrecedent);
			//commentaire += " + " + avance.getNbCheques() + " cheque" + (avance.getNbCheques()>1?"s":"") + " avancés le " + DateFormat.getDateInstance(DateFormat.MEDIUM).format(avance.getDate());
		}
